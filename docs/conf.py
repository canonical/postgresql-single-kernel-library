...
html_title = project + " 14"

version_slug = f"{os.environ.get('READTHEDOCS_VERSION', 'local')}"

# Documentation website URL
ogp_site_url = f"https://canonical.com/data/postgresql/docs/{version_slug}/"
...
html_context = {
    ...
    "github_url": "https://github.com/canonical/postgresql-single-kernel-library",
    # Docs branch in the repo; used in links for viewing the source files
    "repo_default_branch": "14/docs",
    ...
    "license": {
        ...
        "url": "https://github.com/canonical/postgresql-operator/blob/14/edge/LICENSE"
    },
}
...
html_baseurl = f"https://canonical.com/data/postgresql/docs/{version_slug}/"
...
linkcheck_ignore = [
    ...
    r"https://matrix\.to/.*",
    "https://example.com",
    # Domains below often reject link checkers
...
#  Decrease to improve run time or increase if links frequently time out.
