...
myst:
  html_meta:
    description: "Explanation of the stereo mode topology for highly available PostgreSQL deployments."
---

(explanation-stereo-mode)=
# Stereo mode
{{vm}}
...
* {ref}`security-hardening-watcher` — the watcher's security posture, hardening and decommissioning.
