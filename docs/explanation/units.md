...
A Charmed PostgreSQL cluster size can be easily {ref}`scaled <scale-replicas>` from 0 to 10 units. {ref}`Contact us <contact>` if you have a cluster with 10+ units.
