...
[Charmed PostgreSQL 14](https://charmhub.io/postgresql?channel=14/stable) ships [Timescale Community edition](https://docs.timescale.com/about/latest/timescaledb-editions/).
