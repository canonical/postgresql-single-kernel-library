...
```shell
$ curl 10.189.210.55:8008/cluster | jq # where 10.189.210.55 is IP of Charmed PostgreSQL Juju unit
...
{
  "members": [
    {
...
Use dedicated {ref}`promote-to-primary action <switchover-failover>` to switchover the primary unit.
