...
To make this tutorial as accessible as possible, we will deploy the machine charm for PostgreSQL using LXD as a local cloud. All operations covered here are also described for Kubernetes and other clouds in the {ref}`how-to guides <how-to>` section.
