...
# The charm imported PATRONI_CONF_PATH from its constants module, which has no
# library equivalent (the lib literal is the container-relative path); spell out
# the VM snap layout like the cluster topology observer script does.
