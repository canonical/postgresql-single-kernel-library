...
def test_substrate_specific_failed_init_message(substrate, manager):
    if substrate == "k8s":
        assert manager.failed_init_message == "Failed to initialize database relation"
    else:
        assert manager.failed_init_message == "Failed to initialize relation database"
